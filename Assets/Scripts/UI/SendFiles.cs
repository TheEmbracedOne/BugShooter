...
public class SendFiles : MonoBehaviour
{
    ...
    void Start()
    {
        //var filePaths : String[] = Directory.GetFiles((Application.dataPath, "*txt");
        //StartCoroutine(Upload());
        //GameObject[] EnemyList = (Path.GetFileName("/id.txt"));
        //var filePaths : String[] = Directory.GetFiles("/", "*.txt");
        //Debug.Log(filePaths);
